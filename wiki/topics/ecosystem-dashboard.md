...
> 脚本生成 @2026-09-14 22:51（`python scripts/dashboard_snapshot.py --gen`），**git 事实以本表为准**；上方手写行只承担业务叙事。远程列：`名✓`=已同步 / `名+N`=本地领先 N / **无远程**=单点风险。

| 仓库 | 分支 | HEAD | 静默 | dirty | 远程 |
|------|------|------|------|-------|------|
| `TechReq/EnvDataClassify` | `main` | `a7de7b2` 2026-07-23 | 53d  🕸️? | 1 | gitlab✓ |
| `TechReq/SonarFOM` | `main` | `9456931` 2026-08-12 | 33d  🕸️? | 0 | gitlab✓ |
| `TechReq/SonarSim` | `main` | `2a0ebf3` 2026-06-04 | 102d  🕸️? | 0 | gitlab✓ |
| `TechReq/USBL` | `main` | `accc52a` 2026-05-25 | 112d  🕸️? | 3 | gitlab✓ / origin✓ |
| `TechReq/USBL_hw` | `main` | `eb7252a` 2026-07-17 | 59d  🕸️? | 14 | gitlab+6 |
| `TechReq/UWAcomm` | `main` | `53e41e7` 2026-09-02 | 12d | 2 | gitlab+1 / origin+24 |
| `TechReq/UWAcomm_usbl` | `main` | `73cf223` 2026-06-09 | 97d  🕸️? | 22 | gitlab✓ |
| `TechReq/UWAnet` | `main` | `e3b45c5` 2026-05-25 | 112d  🕸️? | 2 | gitlab✓ / origin✓ |
| `DocProcess/AcousticLiteracy` | `main` | `7447ca4` 2026-09-14 | 0d | 2 | **无远程** |
| `DocProcess/AUVNetCoop` | `main` | `5a6bbfc` 2026-09-14 | 0d | 0 | **无远程** |
| `DocProcess/AUVProposal` | `main` | `b5a3c8e` 2026-09-09 | 5d | 48 | gitlab✓ |
| `DocProcess/AUVSlopeMCM` | `main` | `82b78b8` 2026-09-11 | 3d | 24 | **无远程** |
| `DocProcess/AUVSurvey` | `main` | `6a79e02` 2026-07-25 | 51d  🕸️? | 10 | gitlab✓ |
| `DocProcess/CommSimSupport` | — | 无 git | — | — | — |
| `DocProcess/CooperativeASW` | `main` | `5da5de1` 2026-06-04 | 102d  🕸️? | 0 | gitlab✓ |
| `DocProcess/CooperativeDetection` | `master` | `6113b96` 2026-05-09 | 128d  🕸️? | 0 | gitlab✓ |
| `DocProcess/CoupledMultiOrder` | `main` | `401b4b4` 2026-08-07 | 38d  🕸️? | 0 | gitlab✓ |
| `DocProcess/DeepSeaIndustry` | `main` | `97fa2c3` 2026-08-30 | 15d | 15 | **无远程** |
| `DocProcess/DigitalTwinGuide` | `master` | `4d9746e` 2026-08-18 | 27d | 0 | gitlab✓ |
| `DocProcess/ImgSonarTwin` | `main` | `5300532` 2026-07-20 | 56d  🕸️? | 1 | gitlab✓ |
| `DocProcess/OceanEnvSupport` | `main` | `15833b0` 2026-07-09 | 67d  🕸️? | 0 | gitlab✓ |
| `DocProcess/PaperReview` | `master` | `b3568f6` 2026-05-09 | 128d  🕸️? | 7 | gitlab✓ |
| `DocProcess/papers` | `?` | **0 commit** | — | 19 | — |
| `DocProcess/PaperTrans` | `main` | `ed1a7ad` 2026-06-16 | 90d  🕸️? | 0 | gitlab✓ |
| `DocProcess/Pricing` | `main` | `fef4f28` 2026-05-25 | 112d  🕸️? | 15 | gitlab✓ |
| `DocProcess/SoSCommSupport` | `main` | `0cc3677` 2026-09-14 | 0d | 0 | **无远程** |
| `DocProcess/UUVCommSwarmSim` | `main` | `84fe9c9` 2026-09-13 | 1d | 26 | **无远程** |
| `DocProcess/UWAcommTrial` | — | 无 git | — | — | — |
| `DocProcess/UWAprojDoc` | `master` | `eed5374` 2026-05-29 | 108d  🕸️? | 2 | gitlab✓ |
| `DocProcess/UWCombatPlatform` | `main` | `3ce4928` 2026-06-26 | 80d  🕸️? | 0 | gitlab✓ |
| `DocProcess/VisioForge` | `main` | `07f40cd` 2026-08-18 | 27d | 0 | gitlab✓ |
| `DocProcess/XiaojingLaunch` | `main` | `0b30cd3` 2026-09-08 | 6d | 0 | **无远程** |
| `Tools/AnthropicPPT` | `main` | `438c57e` 2026-06-15 | 91d  🕸️? | 14 | gitlab✓ |
| `Tools/FieldKit` | `main` | `5a9d75b` 2026-06-15 | 91d  🕸️? | 0 | gitlab✓ |
| `Tools/FlowGen` | `main` | `385072e` 2026-06-15 | 91d  🕸️? | 10 | gitlab✓ |
| `Tools/IconForge` | `main` | `a6b361a` 2026-05-29 | 108d  🕸️? | 0 | gitlab✓ |
| `Tools/MetalDinoForge` | `?` | **0 commit** | — | 24 | — |
| `Tools/ObsidianStyleLab` | `main` | `e48dabf` 2026-06-16 | 90d  🕸️? | 16 | **无远程** |
| `Tools/ppt-master` | `main` | `54ef7c7` 2026-06-23 | 83d  🕸️? | 6 | origin✓ |
| `Tools/SlotForge` | — | 无 git | — | — | — |
| `Patents` | `master` | `8654521` 2026-09-06 | 8d | 122 | **无远程** |
| `Ohmybrain` | `main` | `ba98378` 2026-09-13 | 1d | 16 | gitlab+15 / origin+15 |
| `ohmybrain-core` | `main` | `844ee8c` 2026-05-25 | 112d  🕸️? | 20 | gitlab✓ / origin✓ |
...
| Memory 条目 | **111** | 4 类：user 1 / feedback 35 / project 72 / reference 3（见 [[memory-index]]；最新含 DeepSeaIndustry / XiaojingLaunch / AcousticLiteracy / AUVSlopeMCM / UUVCommSwarmSim / SoSCommSupport / AUVNetCoop init + PPT autofit / pptx COM 导图 / endParaRPr 次序 / open-newline 截断 / docx 配图素样式 feedback 条目） |
