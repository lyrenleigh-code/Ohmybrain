...
| Memory 条目 | **87** | 4 类：user 1 / feedback 22 / project 61 / reference 3（见 [[memory-index]]；含 ppt-master adoption + 2026-06-24 自检 + PaperTrans init + UWAcommTrial init + UWCombatPlatform init + inplace-edit-no-version 条目） |
| MCP servers | **6** | context7 / exa / github / memory / playwright / sequential-thinking |

> ADR 不是独立文件，集中存放在 [[decision-log]]（章节形式 ADR-001~034）。
...
- [[memory-index]] — auto-memory 87 条目索引（本页 session 锚点来源）
