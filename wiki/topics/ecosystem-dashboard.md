...
| 指标 | 数值 | 说明 |
|------|------|------|
| wiki 内容页 | **112** | 20 concepts + 8 entities + 12 architecture + 1 agents + 1 workflows + 5 topics + 4 explorations + 36 source-summaries + 25 mcp-entities + 0 comparisons |
| wiki 总文件 | **114** | 112 内容页 + 根 `index.md` + `log.md` |
...
| Memory 条目 | **99** | 4 类：user 1 / feedback 30 / project 65 / reference 3（见 [[memory-index]]；最新含 SonarFOM / EnvDataClassify / AUVProposal / AUVSurvey / CoupledMultiOrder init + UWAcomm 07-13/15/21 session + PPT autofit / docx 容器 feedback 条目） |
