...
> 脚本生成 @2026-08-29 10:46（`python scripts/dashboard_snapshot.py --gen`），**git 事实以本表为准**；上方手写行只承担业务叙事。远程列：`名✓`=已同步 / `名+N`=本地领先 N / **无远程**=单点风险。

| 仓库 | 分支 | HEAD | 静默 | dirty | 远程 |
|------|------|------|------|-------|------|
| `TechReq/EnvDataClassify` | `main` | `a7de7b2` 2026-07-23 | 37d  🕸️? | 1 | gitlab✓ |
| `TechReq/SonarFOM` | `main` | `9456931` 2026-08-12 | 17d | 0 | gitlab✓ |
| `TechReq/SonarSim` | `main` | `2a0ebf3` 2026-06-04 | 86d  🕸️? | 0 | gitlab✓ |
| `TechReq/USBL` | `main` | `accc52a` 2026-05-25 | 96d  🕸️? | 3 | gitlab✓ / origin✓ |
| `TechReq/USBL_hw` | `main` | `eb7252a` 2026-07-17 | 43d  🕸️? | 14 | gitlab+6 |
| `TechReq/UWAcomm` | `main` | `b66c918` 2026-08-23 | 6d | 2 | gitlab✓ / origin+23 |
| `TechReq/UWAcomm_usbl` | `main` | `73cf223` 2026-06-09 | 81d  🕸️? | 22 | gitlab✓ |
| `TechReq/UWAnet` | `main` | `e3b45c5` 2026-05-25 | 96d  🕸️? | 2 | gitlab✓ / origin✓ |
| `DocProcess/AUVProposal` | `main` | `b7d0921` 2026-08-28 | 1d | 4 | gitlab✓ |
| `DocProcess/AUVSurvey` | `main` | `6a79e02` 2026-07-25 | 35d  🕸️? | 10 | gitlab✓ |
| `DocProcess/CommSimSupport` | — | 无 git | — | — | — |
| `DocProcess/CooperativeASW` | `main` | `5da5de1` 2026-06-04 | 86d  🕸️? | 0 | gitlab✓ |
| `DocProcess/CooperativeDetection` | `master` | `6113b96` 2026-05-09 | 112d  🕸️? | 0 | gitlab✓ |
| `DocProcess/CoupledMultiOrder` | `main` | `401b4b4` 2026-08-07 | 22d | 0 | gitlab✓ |
| `DocProcess/DigitalTwinGuide` | `master` | `4d9746e` 2026-08-18 | 11d | 0 | gitlab✓ |
| `DocProcess/ImgSonarTwin` | `main` | `5300532` 2026-07-20 | 40d  🕸️? | 1 | gitlab✓ |
| `DocProcess/OceanEnvSupport` | `main` | `15833b0` 2026-07-09 | 51d  🕸️? | 0 | gitlab✓ |
| `DocProcess/PaperReview` | `master` | `b3568f6` 2026-05-09 | 112d  🕸️? | 7 | gitlab✓ |
| `DocProcess/papers` | `?` | **0 commit** | — | 19 | — |
| `DocProcess/PaperTrans` | `main` | `ed1a7ad` 2026-06-16 | 74d  🕸️? | 0 | gitlab✓ |
| `DocProcess/Pricing` | `main` | `fef4f28` 2026-05-25 | 96d  🕸️? | 15 | gitlab✓ |
| `DocProcess/UWAcommTrial` | — | 无 git | — | — | — |
| `DocProcess/UWAprojDoc` | `master` | `eed5374` 2026-05-29 | 92d  🕸️? | 2 | gitlab✓ |
| `DocProcess/UWCombatPlatform` | `main` | `3ce4928` 2026-06-26 | 64d  🕸️? | 0 | gitlab✓ |
| `DocProcess/VisioForge` | `main` | `07f40cd` 2026-08-18 | 11d | 0 | gitlab✓ |
| `Tools/AnthropicPPT` | `main` | `438c57e` 2026-06-15 | 75d  🕸️? | 14 | gitlab✓ |
| `Tools/FieldKit` | `main` | `5a9d75b` 2026-06-15 | 75d  🕸️? | 0 | gitlab✓ |
| `Tools/FlowGen` | `main` | `385072e` 2026-06-15 | 75d  🕸️? | 10 | gitlab✓ |
| `Tools/IconForge` | `main` | `a6b361a` 2026-05-29 | 92d  🕸️? | 0 | gitlab✓ |
| `Tools/MetalDinoForge` | `?` | **0 commit** | — | 24 | — |
| `Tools/ObsidianStyleLab` | `main` | `e48dabf` 2026-06-16 | 74d  🕸️? | 16 | **无远程** |
| `Tools/ppt-master` | `main` | `54ef7c7` 2026-06-23 | 67d  🕸️? | 6 | origin✓ |
| `Tools/SlotForge` | — | 无 git | — | — | — |
| `Patents` | `master` | `53bd96d` 2026-06-29 | 61d  🕸️? | 93 | **无远程** |
| `Ohmybrain` | `main` | `4de5ee8` 2026-08-24 | 5d | 1 | gitlab+8 / origin+8 |
| `ohmybrain-core` | `main` | `844ee8c` 2026-05-25 | 96d  🕸️? | 20 | gitlab✓ / origin✓ |
...
| Memory 条目 | **100** | 4 类：user 1 / feedback 31 / project 65 / reference 3（见 [[memory-index]]；最新含 SonarFOM / EnvDataClassify / AUVProposal / AUVSurvey / CoupledMultiOrder init + UWAcomm 07-13/15/21 session + PPT autofit / docx 容器 feedback 条目） |
