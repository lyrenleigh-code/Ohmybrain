...
| Memory 条目 | **106** | 4 类：user 1 / feedback 33 / project 69 / reference 3（见 [[memory-index]]；最新含 SonarFOM / EnvDataClassify / AUVProposal / AUVSurvey / CoupledMultiOrder init + UWAcomm 07-13/15/21 session + PPT autofit / docx 容器 feedback 条目） |
