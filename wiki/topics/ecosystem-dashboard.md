...
> 脚本生成 @2026-09-04 14:48（`python scripts/dashboard_snapshot.py --gen`），**git 事实以本表为准**；上方手写行只承担业务叙事。远程列：`名✓`=已同步 / `名+N`=本地领先 N / **无远程**=单点风险。

| 仓库 | 分支 | HEAD | 静默 | dirty | 远程 |
|------|------|------|------|-------|------|
| `TechReq/EnvDataClassify` | `main` | `a7de7b2` 2026-07-23 | 43d  🕸️? | 1 | gitlab✓ |
| `TechReq/SonarFOM` | `main` | `9456931` 2026-08-12 | 23d | 0 | gitlab✓ |
| `TechReq/SonarSim` | `main` | `2a0ebf3` 2026-06-04 | 92d  🕸️? | 0 | gitlab✓ |
| `TechReq/USBL` | `main` | `accc52a` 2026-05-25 | 102d  🕸️? | 3 | gitlab✓ / origin✓ |
| `TechReq/USBL_hw` | `main` | `eb7252a` 2026-07-17 | 49d  🕸️? | 14 | gitlab+6 |
| `TechReq/UWAcomm` | `main` | `53e41e7` 2026-09-02 | 2d | 2 | gitlab+1 / origin+24 |
| `TechReq/UWAcomm_usbl` | `main` | `73cf223` 2026-06-09 | 87d  🕸️? | 22 | gitlab✓ |
| `TechReq/UWAnet` | `main` | `e3b45c5` 2026-05-25 | 102d  🕸️? | 2 | gitlab✓ / origin✓ |
| `DocProcess/AcousticLiteracy` | `main` | `85bd9cd` 2026-09-02 | 2d | 0 | **无远程** |
| `DocProcess/AUVProposal` | `main` | `a48f02d` 2026-09-03 | 1d | 3 | gitlab✓ |
| `DocProcess/AUVSlopeMCM` | `main` | `723d2fb` 2026-09-04 | 0d | 0 | **无远程** |
| `DocProcess/AUVSurvey` | `main` | `6a79e02` 2026-07-25 | 41d  🕸️? | 10 | gitlab✓ |
| `DocProcess/CommSimSupport` | — | 无 git | — | — | — |
| `DocProcess/CooperativeASW` | `main` | `5da5de1` 2026-06-04 | 92d  🕸️? | 0 | gitlab✓ |
| `DocProcess/CooperativeDetection` | `master` | `6113b96` 2026-05-09 | 118d  🕸️? | 0 | gitlab✓ |
| `DocProcess/CoupledMultiOrder` | `main` | `401b4b4` 2026-08-07 | 28d | 0 | gitlab✓ |
| `DocProcess/DeepSeaIndustry` | `main` | `97fa2c3` 2026-08-30 | 5d | 15 | **无远程** |
| `DocProcess/DigitalTwinGuide` | `master` | `4d9746e` 2026-08-18 | 17d | 0 | gitlab✓ |
| `DocProcess/ImgSonarTwin` | `main` | `5300532` 2026-07-20 | 46d  🕸️? | 1 | gitlab✓ |
| `DocProcess/OceanEnvSupport` | `main` | `15833b0` 2026-07-09 | 57d  🕸️? | 0 | gitlab✓ |
| `DocProcess/PaperReview` | `master` | `b3568f6` 2026-05-09 | 118d  🕸️? | 7 | gitlab✓ |
| `DocProcess/papers` | `?` | **0 commit** | — | 19 | — |
| `DocProcess/PaperTrans` | `main` | `ed1a7ad` 2026-06-16 | 80d  🕸️? | 0 | gitlab✓ |
| `DocProcess/Pricing` | `main` | `fef4f28` 2026-05-25 | 102d  🕸️? | 15 | gitlab✓ |
| `DocProcess/UWAcommTrial` | — | 无 git | — | — | — |
| `DocProcess/UWAprojDoc` | `master` | `eed5374` 2026-05-29 | 98d  🕸️? | 2 | gitlab✓ |
| `DocProcess/UWCombatPlatform` | `main` | `3ce4928` 2026-06-26 | 70d  🕸️? | 0 | gitlab✓ |
| `DocProcess/VisioForge` | `main` | `07f40cd` 2026-08-18 | 17d | 0 | gitlab✓ |
| `DocProcess/XiaojingLaunch` | `main` | `2a26b38` 2026-09-04 | 0d | 0 | **无远程** |
| `Tools/AnthropicPPT` | `main` | `438c57e` 2026-06-15 | 81d  🕸️? | 14 | gitlab✓ |
| `Tools/FieldKit` | `main` | `5a9d75b` 2026-06-15 | 81d  🕸️? | 0 | gitlab✓ |
| `Tools/FlowGen` | `main` | `385072e` 2026-06-15 | 81d  🕸️? | 10 | gitlab✓ |
| `Tools/IconForge` | `main` | `a6b361a` 2026-05-29 | 98d  🕸️? | 0 | gitlab✓ |
| `Tools/MetalDinoForge` | `?` | **0 commit** | — | 24 | — |
| `Tools/ObsidianStyleLab` | `main` | `e48dabf` 2026-06-16 | 80d  🕸️? | 16 | **无远程** |
| `Tools/ppt-master` | `main` | `54ef7c7` 2026-06-23 | 73d  🕸️? | 6 | origin✓ |
| `Tools/SlotForge` | — | 无 git | — | — | — |
| `Patents` | `master` | `53bd96d` 2026-06-29 | 67d  🕸️? | 93 | **无远程** |
| `Ohmybrain` | `main` | `814d0da` 2026-08-30 | 5d | 19 | gitlab+12 / origin+12 |
| `ohmybrain-core` | `main` | `844ee8c` 2026-05-25 | 102d  🕸️? | 20 | gitlab✓ / origin✓ |
...
| Memory 条目 | **108** | 4 类：user 1 / feedback 35 / project 69 / reference 3（见 [[memory-index]]；最新含 DeepSeaIndustry / XiaojingLaunch / AcousticLiteracy / AUVSlopeMCM init + PPT autofit / pptx COM 导图 / endParaRPr 次序 / open-newline 截断 / docx 配图素样式 feedback 条目） |
