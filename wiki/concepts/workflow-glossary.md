...
| **ADR** | Architecture Decision Record 架构决策记录；Hub 中以章节形式（ADR-001~031）存放于 [[../architecture/decision-log]]，引用一律链 decision-log 而非悬空 ADR-N | [[../architecture/decision-log]] |
...
- [[../architecture/decision-log]] — ADR-001~031 章节存放处
