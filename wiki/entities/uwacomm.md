...
- **相关论文（2026-04-22 批量摄入，UWA 多普勒专题）**：
  - [[sun-2020-dsss-passband-doppler]] — 模块 10 DSSS 通道符号级 α 跟踪的目标改造参考（Sun-2020）
  - [[wei-2020-dual-hfm-speed-spectrum]] — 模块 10 `est_alpha_dual_hfm_vss.m` 的理论源头
  - [[muzzammil-2019-cpofdm-doppler-interp]] — 模块 10 `est_doppler_cp.m` Method 1 理论依据；±2.4e-4 阈值突破路径
  - [[lalevee-2025-dichotomous-doppler]] — FPGA 嵌入式多普勒估计的硬件工程参考
  - [[yangyang-2026-uwa-otfs-nonuniform-doppler]] — 模块 07 OTFS DD 域导频估计的最新参考
  - [[zhengtonghui-2025-dd-mmse-teq]] — SC-UWA DD 域 Turbo 均衡，可作为第 7 体制候选参考
