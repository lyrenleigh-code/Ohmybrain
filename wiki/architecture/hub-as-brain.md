...
| 7 | **memory 条目索引** | 100 个 auto-memory 文件没在 Hub 中出现 | `MEMORY.md`（索引 101 行）但与 Hub wiki 脱节 | ✓ [[memory-index]] · 2026-06-10 · 实质填充 |
...
| 资源 | 权威值 | 拆解 |
|------|--------|------|
| **auto-memory 文件** | 100 个 | user 1 / feedback 31 / project 65 / reference 3（`MEMORY.md` 索引 101 行，含 1 行指向全局 skill 非 memory 文件） |
