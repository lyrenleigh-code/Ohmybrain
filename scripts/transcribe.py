...
用法：
  python3 scripts/transcribe.py <输入文件> [--lang Chinese] [--type video|podcast]

示例：
  python3 scripts/transcribe.py lecture.mp4
  python3 scripts/transcribe.py podcast.mp3 --type podcast --lang Chinese
"""
import sys
import os
import io
